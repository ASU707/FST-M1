...
public class jobPosting_WithExample {
	WebDriver driver;
	WebDriverWait wait;
	

	@Given("^With Example User is on Post Job Page$")
	public void jobPostPage_Example() 
	{
	...
	@When("^With Example User enters details for Job with \"(.*)\" and \"(.*)\" and \"(.*)\" and \"(.*)\" and \"(.*)\"$")
	public void postJobPage_Example(String email, String jobTitle, String description, String applicationURL, String companyName) throws Throwable {
	...
	@Then("^With Example User Creates and Verifies the Job with \"(.*)\"$")
	public void verifyPostedJob_Example(String verifyJobName) throws Throwable {
    ...
    @And("^With Example Close the Job Listing Verification browser$")
	 public void closeThe4thBrowser() throws Throwable {
